...
$('.tooltipped').tooltip({delay: 30});
      ...
      function updateProdPromo() {
          ...
          var i = rowCount;
          var cell1 = row.insertCell(0);
            cell1.innerHTML = '<input type="text" value="'+promoProdType+'" id="updateProdPromType['+i+']" name="updateProdPromType" disabled="disabled" style="color:black;"/>';
          var cell2 = row.insertCell(1);
      ...
      // add product/service in package BEGIN
        ...
        function updatePackageService() {
            ...
            var i = rowCount;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = '<input type="text" value="'+promoType+'" id="updateServPackType['+i+']" name="updateServPackType" readonly style="color:black;"/>';
            var cell2 = row.insertCell(1);
            var updateServPackQty = document.createElement("input");
            updateServPackQty.type = "number";
            updateServPackQty.name = "updateServPackQty";
        ...
        function updatePackageProduct() {
            ...
            var i = rowCount;
            var cell1 = row.insertCell(0);
            cell1.innerHTML = '<input type="text" value="'+promoType+'" id="updateProdPackType['+i+']" name="updateProdPackType" readonly style="color:black;"/>';
            var cell2 = row.insertCell(1);
