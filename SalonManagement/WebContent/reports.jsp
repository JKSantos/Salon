...
<!--                     <div class="aside aside1 z-depth-barts">
                    ...
                    <div class="main z-depth-barts" style="margin-left: 20px; margin-right: 20px;">
                        ...
                        <h3 class="grey-text text-darken-1">Reports</h3>
                        <div class="col s12">
                        <div class="input-field col s3" style="top: 80px !important; margin-left: 15px; width: 150px !important;">
                              <select id="qfilter">
                                <option></option>
                              </select>
                              <label for="report" class="active">Report</label>
                        </div>
                        <div class="input-field col s3" style="top: 80px !important; margin-left: 15px; width: 150px !important;">
                              <input type="date" class="datereport">
                              <label for="report" class="active">From</label>
                        </div>
                        <div class="input-field col s3" style="top: 80px !important; margin-left: 15px; width: 150px !important;">
                              <input type="date" class="datereport">
                              <label for="report" class="active">To</label>
                        </div>
                        </div>
