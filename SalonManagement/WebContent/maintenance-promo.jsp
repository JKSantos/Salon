                                      ...
                                      <div class="row">
                                        <!-- service -->
                                          ...
                                          <div class="input-field col s3 left-align" style="margin-top: -1px;">
                                              <button class="waves-effect waves-light btn-flat orange" id="promoAddSvc" onclick="addServPromo()"><i class="material-icons">add</i></button>
                                          </div>
                                          <!--product  -->
                                          <div class="input-field col s8">
                                          ...
                                          <div class="input-field col s3 left-align" style="margin-top: -1px;">
                                              <button class="waves-effect waves-light btn-flat orange" onclick="addProdPromo()"><i class="material-icons">add</i></button>
                                          </div>
                                        <!-- end -->
                                        <!-- start table -->
                                          <div class="input-field col s12">
